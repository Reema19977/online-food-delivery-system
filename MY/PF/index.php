...
<div id="shopping-cart">
        <div class="txt-heading">
            <div class="txt-heading-label">Dish List</div>

            <a id="btnEmpty" href="index.php?action=empty"><img src="image/empty-cart.jpg" alt="empty-cart" title="Empty Cart" class="float-right" width="25" height="30"></a>
